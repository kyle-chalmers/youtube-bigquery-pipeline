...
## Why the differences are expected (documented, checked 2026-09-05)

- **Average view duration uses engaged views.** YouTube Help, [Understand your YouTube content performance](https://support.google.com/youtube/answer/12220281): "Average view duration: Average minutes watched among those who stayed to watch. This is calculated from engaged views and their corresponding watch time." Average percentage viewed says the same. The [engaged views explainer](https://blog.youtube/inside-youtube/engaged-views-youtube-explained/) adds that "the vast majority of analytics remain anchored on engaged views, so the way metrics like CTR, AVD, and retention are calculated hasn't changed."
- **Views count from the first frame for every format since 2026-08-24.** Same explainer: "Starting August 24, 2026, views across YouTube are counted from the first frame going forward: Shorts, Long Form, Podcasts, Live." The API side is the 2026-08-27 entry of the [Analytics and Reporting APIs revision history](https://developers.google.com/youtube/analytics/revision_history): public views "the moment a video begins to play", engaged views unchanged, "monetization eligibility and the majority of core performance metrics are unaffected as they remain anchored on engaged metrics." Shorts made the same move on 2025-03-31 (2025-03-26 entry). This is why long-form views on this channel exceed engaged views only from 2026-08-24.
- **Studio's counters keep moving after a report is generated.** [How YouTube counts views](https://support.google.com/youtube/answer/2991785): "To verify that metrics are accurate, YouTube may temporarily slow down, freeze, or change your metric count, and discard low-quality playbacks" and "we're constantly confirming and adjusting engagement events." [Invalid traffic on your videos](https://support.google.com/youtube/answer/10285842): "Invalid traffic detection and updates can take up to 30 days to fully complete." A Reporting API report is a point-in-time snapshot of that moving number.
- **The Reporting API replaces data only by issuing a new report.** [Reporting API reports guide](https://developers.google.com/youtube/reporting/v1/reports): "Backfill data refers to a dataset that replaces a previously delivered set. When a backfill data report is available, your application should retrieve the new report and update your stored data" and "If two new reports have the same startTime and endTime property values, only import the report with the newer createTime value." The loader does exactly this; a day with no backfill report simply keeps the number as first generated, which is the 08-27, 08-28 and 08-31 case above.
- **Analytics data lags by days and is not final on arrival.** [Check your YouTube Analytics data](https://support.google.com/youtube/answer/6085583): "there can be a delay of a few days before data is viewable in YouTube Analytics"; earnings data "doesn't reflect invalid activity adjustments in real time."
